...
Usage:
    ./dev/validate-smoke-test.py --test-dir /path/to/test
    ./dev/validate-smoke-test.py --test-dir /path --output results.json
    ./dev/validate-smoke-test.py --test-dir /path --skip-cook-check=true
