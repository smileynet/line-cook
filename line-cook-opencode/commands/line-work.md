...
Execute `/line-prep` and wait for completion.

### Step 2: Run /line-cook

**If `$ARGUMENTS` provided:**
Execute `/line-cook $ARGUMENTS`
...
Execute `/line-serve` and wait for review to complete.

### Step 4: Run /line-tidy

Execute `/line-tidy` to file discovered work, commit, sync, and push.
