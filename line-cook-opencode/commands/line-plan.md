---
description: Plan recipes with tracer dish methodology before cooking
---

## Summary

**Create human-readable menu plans for recipes (features) using tracer dish methodology.** Prep step before creating beads.

**When run directly:** STOP after creating menu plan and wait for user approval before converting to beads.
