...
python ~/code/line-cook/plugins/claude-code/scripts/line-loop.py -n 3 -v --skip-initial-sync

# Or with default settings
python ~/code/line-cook/plugins/claude-code/scripts/line-loop.py -n 5
```
