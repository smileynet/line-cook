...
- [Project Structure](dev/project-structure.md) — Zones, plugins, and build layout
- [Line Loop Internals](dev/line-loop-internals.md) — Autonomous loop architecture
- [Kiro Troubleshooting](dev/kiro-troubleshooting.md) — Kiro-specific issues and fixes
