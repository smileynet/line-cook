...
Usage:
    ./scripts/doctor-docs.py                    # Markdown report
    ./scripts/doctor-docs.py --json             # JSON output
    ./scripts/doctor-docs.py --check-external   # Validate external URLs
    ./scripts/doctor-docs.py --category links   # Links only
    ./scripts/doctor-docs.py --fix              # Auto-fix simple issues (future)
