...
def main() -> None:
    ...
    print("  @line-init               - Initialize project setup")
    print("  @line-getting-started    - Show workflow guide")
    print("  @line-onboarding         - Guided onboarding walkthrough")
    print("  @line-whats-new          - Show recent changes")
    print("  @line-doctor             - Diagnose environment issues")
