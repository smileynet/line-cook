...
1. **"No, just checking"** — Show recommendations for any warnings and stop
2. **"Yes, something is wrong"** — Ask them to describe the issue, then proceed to targeted troubleshooting
3. **"Tasks seem stuck"** — Troubleshoot stale/blocked tasks
4. **"Commands aren't working"** — Troubleshoot plugin/script issues
