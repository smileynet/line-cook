...
Options:
1. **"Walk me through with a demo project"** — Creates a small demo project with pre-built tasks, then walks through both cycles
2. **"Explain using my current project"** — Uses your existing beads and code as examples
3. **"Just show me the commands"** — Quick summary of all commands and their purpose
...
Use `AskUserQuestion` to offer demo choice:

**"Which demo project?"**

1. **Simple (recommended)** — 6 tasks, JavaScript utility library
...
**"Want to try running /prep to see your ready tasks?"**

1. **Yes, show me** — Invoke `Skill(skill="line:prep")`
2. **No, continue the tour** — Proceed to Step 6
