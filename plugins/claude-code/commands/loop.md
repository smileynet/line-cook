...
│  run_phase():                                                           │
│  - Invoke claude CLI with skill (e.g., /line:cook)                      │
...
| `parsing.py` | Parse claude output | `parse_serve_result()`, `parse_serve_feedback()`, `parse_intent_block()`, `extract_actions_from_event()`, `update_action_from_result()` | phase, iteration |
...
#### parsing.py
Regex-based parsing of claude's output:
...
- **run_phase()**: Invoke claude CLI, stream stdout, detect signals, track actions
