...
| Debug loop issues | `/line:loop watch --log-lines 100 --interval 0` |
| Review what happened | `/line:loop history --actions` |
| Post-loop audit | `/line:loop close` |
...
/line:loop watch     # Live progress + logs
```
...
|--------|---------------------------|---------------------------|
| **Cook timeout** | 2 minutes (Claude Code default) | 30 minutes (configurable, active extension up to 1hr) |
