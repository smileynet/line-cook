...
**Epic branch detection** uses data from `state-snapshot.py` output:
- `branch_recommendation.expected`: the branch you should be on (e.g., `epic/<id>`)
- `branch_recommendation.current`: the branch you're currently on
- `branch_recommendation.branch_exists`: whether the expected branch already exists
